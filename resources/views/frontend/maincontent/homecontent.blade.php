                    ...
                    <div class="col-lg-6">
                        <div class="single-main-news">
                            ...
                            <div class="news-content">
                                ...
                                <span><a href=""></a>{{ \App\Bengali::bn_date_number(\Carbon\Carbon::parse($firstsectionmain->created_at)->diffForHumans()) }}</span>
                                    ...
                                    <div class="col-lg-9 col-md-9">
                                        <div class="single-health-news">
                                            ...
                                            <div class="health-news-content">
                                                ...
                                                <span><p><a href="#"></a>{{ \App\Bengali::bn_date_number(\Carbon\Carbon::parse($sports_big_thub->created_at)->diffForHumans()) }}</p></span>
                                            </div>
                                        </div>
                                    </div>
                                        <div class="col-lg-3">
                                        @foreach($sports_category_post as $news)
                                            <div class="single-politics-news">
                                                ...
                                                <div class="politics-news-content">
                                                    ...
                                                    <p><a href="#"></a>{{ \App\Bengali::bn_date_number(\Carbon\Carbon::parse($sports_big_thub->created_at)->diffForHumans()) }}</p>
                                                </div>
                                            </div>
                                            @endforeach
                                        </div>
                                ...
                                <section class="widget widget_latest_news_thumb">
                                    ...
                                    <article class="item">
                                        ...
                                        <div class="info">
                                            ...
                                            <span>{{ \App\Bengali::bn_date_number(\Carbon\Carbon::parse($row->created_at)->diffForHumans()) }}</span>
                                        </div>
                                    </article>
                                   @endforeach
                                </section>
                        ...
                        <div class="single-new-news-box">
                            <div class="new-news-image">
                                ...
                                <div class="new-news-content">
                                    ...
                                    <p>{{ \App\Bengali::bn_date_number(\Carbon\Carbon::parse($entertainment_big_thub->created_at)->diffForHumans()) }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
